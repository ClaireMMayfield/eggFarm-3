...
<head>
    ...
    <form name="keepAnimal" action="" onsubmit="" method="post" >
        <input id="animal_type" type="hidden" name="animal_type" value="">
        <input id="current_gold" type="hidden" name="current_gold" value="">
        <input type="submit" value="Save progress">
    </form>

    <img id="sellA" alt = "Sell" src = "sprite_sell_0.png" class="sell">
    <img id = "keepA" alt = "Keep" src = "sprite_keep_0.png" class="keep">
    ...
    <script type="text/javascript">
        ...
        * */
        function sellB(){
            // Update gold
            var new_gold = parseInt(Game.gold);
            new_gold += 500;
            ...
            document.getElementById('keepA').style.display = 'none';
            document.getElementById('sellA').style.display = 'none';
            document.getElementById('your_gold').value = "Your gold: " + new_gold + " + 500!";
        }
